class fstep::proxy::shibboleth (
  ...
  $home_url                         = 'https://foodsecurity-tep.net/',
  ...
  $sp_assertion_consumer_services   = [
    { 'binding'  => 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Artifact',
      'location' => 'https://foodsecurity-tep.net/Shibboleth.sso/SAML2/Artifact' },
  ],
  $sp_slo_service                   = {
    'binding'  => 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect',
    'location' => 'https://foodsecurity-tep.net/Shibboleth.sso/SLO/Redirect'
  },
